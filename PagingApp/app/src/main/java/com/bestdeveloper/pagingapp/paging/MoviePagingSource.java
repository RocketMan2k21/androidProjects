package com.bestdeveloper.pagingapp.paging;
...
import com.bestdeveloper.pagingapp.api.APIClient;
    ...
    public Single<LoadResult<Integer, Movie>> loadSingle(@NonNull LoadParams<Integer> loadParams) {
        try{
            ...
            return APIClient.getApiInterface()
                    ...
                    .map(com.bestdeveloper.pagingapp.model.MovieResponse::getMovies)
